...
*Figura 3.1: Interface de registo da aplicação ActiveFrame.*

<br>

### 3.4. Ajuda de Navegação
Para a ajuda de navegação cada campo dos formulários estão previamente preenchidos para ajudar o utilizador a saber o que tem de colocar, exemplo imagem do formulário.
![Formulário de atividades](imagens/form-atividades.png)

<br>

### 3.5. Validações de formulários
Algumas das validações de formulários são feitas através de XML que não permite introdução de valores expecificos enquanto outras são feitas com o JS, exemplo da password, que é validada se tem mais de 6 caracteres.
