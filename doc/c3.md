...
| :---: | :---: |
| ![Validação index.html](imagens/index-validator.png) | ![Formulário de Alimentação](imagens/form-refeicao.png) |
| ![Validação sobre.html](imagens/sobre-validator.png) | ![Formulário de Alimentação](imagens/form-refeicao.png) |
