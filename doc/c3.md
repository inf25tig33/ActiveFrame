...
Pode ser efetuado o registo da conta atravez do botão "Criar conta" no canto superior direito.
Este registo vai ficar guardado em localStorage e irá funcionar enquanto existir memoria cache, se limparmos a cache, terás de criar conta novamente.
