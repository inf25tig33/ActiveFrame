...
Como cumprimentos da implementação foram levados em consideração todos os pontos que o professor pediu, incluindo:
4 páginas estáticas
1 Documento XML e o seu schema
Definição do CSS externo e nunca inline
HTML semântico
Tabela
Lista
imagens
Ligações externas e internas (hyperlinks)
formulários
css por ID e classes
Propriedades de texto e fonte
Fundo da página com cor
Formatação de tabela
Esconder elementos
responsibidade
Conteudo de XML apresentado em HTML com recurso a JS
Um Video com audio
