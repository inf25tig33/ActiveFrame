...
#### 3.1.1. Estruturação da Base de Dados XML (`dados.xml`)
...
#### 3.1.2. Validação Semântica via XML Schema (`schema.xsd`)
...
#### 3.1.3. Lógica e Persistência Híbrida (JSON e LocalStorage)
